...
class SoftmaxModel(Model):
    ...
    def add_placeholders(self):
        ...
        """
        ### YOUR CODE HERE
        self.input_placeholder = tf.placeholder(tf.float32, shape=(Config.batch_size, Config.n_features), name='input')
        self.labels_placeholder = tf.placeholder(tf.float32, shape=(Config.batch_size, Config.n_classes), name='labels')
        ### END YOUR CODE
    ...
    def add_prediction_op(self):
        ...
        """
        ### YOUR CODE HERE
        W = tf.Variable(tf.zeros(shape=[Config.n_features, Config.n_classes], dtype=tf.float32), name='weights')
        b = tf.Variable(tf.zeros(shape=[Config.n_classes], dtype=tf.float32), name='biases')
